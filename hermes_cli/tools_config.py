...
# "Web Search & Extract" picker. All eight providers (brave-free, ddgs,
# searxng, exa, parallel, firecrawl, keenable, xai) live as plugins after
...
def _plugin_web_search_providers() -> list[dict]:
    ...
    After PR #25182, all eight web providers (brave-free, ddgs, searxng,
    exa, parallel, firecrawl, keenable, xai) are plugins; this helper is the sole
