...
def _route_signature(model, runtime: dict, fallback_entry: dict | None = None) -> tuple:
    ...
    return (
        ...
        tuple(str(fallback_entry.get(key) or "") for key in
...
class CLIAgentSetupMixin:
    ...
    def _resolve_turn_agent_config(self, user_message: str) -> dict:
        ...
        reasoning_config, fallback_entry = self._resolve_cli_route_reasoning(
            model=self.model, requested_provider=runtime["requested_provider"],
        )
        route = {
            "model": self.model, "runtime": runtime, "reasoning_config": reasoning_config,
            "fallback_entry": fallback_entry,
            "signature": _route_signature(self.model, runtime, fallback_entry),
        }
        overrides = None
    ...
    def _init_agent(self, *, model_override: str = None, runtime_override: dict = None, request_overrides: dict | None = None) -> bool:
        ...
        try:
            ...
            self.agent = AIAgent(
                ...
                reasoning_config=effective_reasoning, service_tier=self.service_tier,
