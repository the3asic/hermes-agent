...
class TestRunBackgroundTask:
    ...
    @pytest.mark.asyncio
    async def test_discord_channel_contract_reaches_agent_constructor(
        self, monkeypatch
    ):
                ...
                Platform.DISCORD: PlatformConfig(
                    ...
                    channel_overrides={
                        "channel": ChannelOverride(
                            system_prompt="Mental lane prompt",
        ...
        assert kwargs["ephemeral_system_prompt"] == "Mental lane prompt"
