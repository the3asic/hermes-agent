...
class SessionDB(
    ...
    def __init__(self, db_path: Path = None, read_only: bool = False, *, allow_fts_rebuild: bool = False):
        self.db_path = db_path or _default_db_path()
        _ensure_test_isolation(self.db_path)  # before any connection/pragma/mkdir
        self.read_only = read_only
        # Full index scans belong to explicit offline repair, never ordinary opens.
        ...
        while True:
            ...
            try:
                ...
                if isinstance(exc, sqlite3.DatabaseError):
                    ...
                    # rows are intact: live handles detach; only offline repair may rebuild.
